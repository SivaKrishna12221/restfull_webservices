...
public class TouristControllerClass {
	...
	public ResponseEntity<?> displayTouristDataById(
		...
		System.out.println(
				"TouristControllerClass.displayTouristDataById()==>before calling ");
		Tourist tourist = service.fetchTouristDataById(id);
		System.out.println(
				"TouristControllerClass.displayTouristDataById()==>After calling");
		return new ResponseEntity<Tourist>(tourist, HttpStatus.OK);

	}
	@PutMapping("/modify")
	public ResponseEntity<String> updateTouristData(
			@RequestBody Tourist tourist) throws Exception {
